...
class FaceMesh(SolutionBase):
  ...
  def __init__(self,
               static_image_mode=False, #whether you are using it for detection only or tracking also
               max_num_faces=2,
               min_detection_confidence=0.5, #detects if above 50% confidence
               min_tracking_confidence=0.5): #keeps tracking if above 50% confidence
